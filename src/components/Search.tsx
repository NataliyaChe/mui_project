    ...
    return (
        <Paper component="form"
            ...
            <IconButton type="button" sx={{ p: '10px' }} aria-label="search">
                <SvgIcon component={SearchIcon} inheritViewBox sx={{fill: '#808191', width: 20, height: 20}}/>
            </IconButton>
            <InputBase
                sx={{ ml: 1, flex: 1 }}
                placeholder="Search"
                inputProps={{ 'aria-label': 'search', fontFamily: 'Inter', fontSize: 14, fontWeight: 600, color: '#808191'}}
            />   
        </Paper>
    )
}